...
router.post("/login", (req, res, next) => {
  ...
  User.findOne({ email: req.body.email })
    .then((foundUser) => {
      ...
      if (doesMatch) {
        const payload = { _id: foundUser._id, email: foundUser.email, name: foundUser.name, profile_image: foundUser.profile_image, recipes: foundUser.recipes, shopping_list_created: foundUser.shopping_list_created };
